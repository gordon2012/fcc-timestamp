          ...
          <div className="container">
            <div className="card">
              ...
              <ol>
                <li>
                  The API endpoint is{' '}
                  <code>GET /api/timestamp/:date_string? </code>
                </li>
                <li>
                  A date string is valid if it can be successfully parsed by{' '}
                  ...
                  (e.g. <code>"2016-11-20"</code>) because this will ensure an
                  UTC timestamp.
                </li>
                <li>
                  If the date string is <strong>empty</strong> it should be
                  equivalent to trigger <code>new Date()</code>, i.e. the
                  service uses the current timestamp.
                </li>
                <li>
                  If the date string is <strong>valid</strong> the api returns a
                ...
                <li>
                  ...
                  a JSON having the structure <br />
                  <code>{`{"unix": null, "utc" : "Invalid Date"}`}</code>. It is
                  what you get from the date manipulation functions used above.
                </li>
              </ol>

              <h2 className="masthead">Example Usage</h2>
              <code className="response">GET /api/timestamp/2015-12-25</code>
              <code className="response">GET /api/timestamp/1450137600</code>
              <h2 className="masthead">Example Output</h2>
              <code className="response">{`{"unix":1451001600000, "utc":"Fri, 25 Dec 2015 00:00:00 GMT"}`}</code>
            </div>

            <div className="card">
              <h2 className="masthead">Parse Date String or Timestamp</h2>
